...
<head>
	...
	<link rel="icon" type="image/png" href="foto/default.png">
...
<body>
	...
	<div class="navbar navbar-default header-highlight">
		<div class="navbar-header">
			<a class="navbar-brand" href="" style="color: #FFF;"><span class="glyphicon glyphicon-send" aria-hidden="true"></span><b>&nbsp;&nbsp;SIS MTs NEGERI 3 PURWOREJO</b></a>
									...
									<li class="<?php if ($sub_menu == "pengguna") {
										...
										<ul>
											...
											<li class="<?php if ($sub_menu == "md") {
															echo 'active';
														} ?>"><a href="users/md"><i class="icon-certificate"></i> <b>PROFIL MADRASAH</b></a>
											</li>
										</ul>
									</li>
