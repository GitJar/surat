          ...
          <div class="panel-heading text-left">
            <div class="row">
              <div class="col-sm-6 text-left">
                <span class="glyphicon glyphicon-home" aria-hidden="true"></span><b class="">&nbsp; EDIT PENGGUNA</b><br><?php echo $md->madrasah; ?>
              </div>
            </div>
          </div>
                ...
                <div class="form-group">
                  ...
                  <div class="col-lg-9">
                    <select class="form-control" name="level" required>
                      ...
                      <option value="kepala" <?php if ($user->level == "kepala") {
                                                echo "selected";
                                              } ?>>Kepala Madrasah</option>
                      <option value="ktu" <?php if ($user->level == "ktu") {
                                            echo "selected";
                                          } ?>>Kepala TU</option>
